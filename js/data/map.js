...
export const MAP = {
  ...
  stations: [
    ...
    {
      id: 'thorngate_relay',
      name: 'Thorngate Relay',
      x: 5500, y: 3800,
      faction: 'neutral',
      services: ['fuel', 'trade'],
      commodities: { food: 'low', ore: 'medium', tech: 'low', exotics: 'none' },
      lore: [
        'THORNGATE RELAY — OPEN PORT',
        'Classification: Neutral',
        '',
        'A fuel stop in the gap between the Wall of Wrecks',
        'and the deep Gravewake. Three converted fuel barges',
        'welded to a docking arm. Small. Functional.',
        '',
        '[ FUEL DEPOT ]',
        'Prices are fair. Rationing is enforced.',
        'First come, first filled.',
        '',
        '[ TRADE DECK ]',
        'Secondhand equipment and salvage odds.',
    ...
    },
    {
      ...
      faction: 'neutral',
      services: ['repair', 'trade'],
      commodities: { food: 'medium', ore: 'low', tech: 'medium', exotics: 'low' },
      lore: [
  ...
  tradeConvoys: [
    ...
    { id: 'convoy_thorngate_coil', routeA: { x: 5500, y: 3800 }, routeB: { x: 13000, y: 4500 }, shipCount: 2, shipType: 'trader-convoy' },
    { id: 'convoy_coil_ashveil',   routeA: { x: 13000, y: 4500 }, routeB: { x: 16000, y: 5000 }, shipCount: 1, shipType: 'trader-convoy' },
  ],

  militiaPatrols: [
    { id: 'coil_inner_patrol', orbitCenter: { x: 13000, y: 4500 }, orbitRadius: 600,  orbitSpeed: 0.12, count: 2, shipType: 'militia-patrol' },
    { id: 'coil_outer_patrol', orbitCenter: { x: 11500, y: 4500 }, orbitRadius: 1200, orbitSpeed: 0.07, count: 1, shipType: 'militia-patrol' },
  ],
